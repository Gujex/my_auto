...
const Card = ({fuel_type_id, right_wheel, car_run_km, price, views, customsPassed, carId, photo, facturers, manId}) => {
    const fuels = {
        2: "ბენზინი",
        3: "დიზელი",
        5: "გაზი/ბენზინი",
   ...
   // const [wait, setWait] = useState('ss')
   //
   //  facturers.map((el) => {
   //      if(el?.man_id === manId) {
   //          console.log(true)
    ...
    return (<div className={Styles.parent}>
        <div className="content d-flex">
            ...
            <div className={Styles.parent__middleContent}>
                <div>car name something Range or some <span>2013 წ</span></div>
                <div>
